...
int rv32_execute(struct rv32_state* cpu, uint32_t opcode) {
    switch (opcode & 0xfe00707f) {
        ...
        case 0x02000033: rv32_i_mul(cpu); return 1;
        case 0x02001033: rv32_i_mulh(cpu); return 1;
        case 0x02002033: rv32_i_mulhsu(cpu); return 1;
        case 0x02003033: rv32_i_mulhu(cpu); return 1;
        case 0x02004033: rv32_i_div(cpu); return 1;
        case 0x02005033: rv32_i_divu(cpu); return 1;
        case 0x02006033: rv32_i_rem(cpu); return 1;
        case 0x02007033: rv32_i_remu(cpu); return 1;
    ...
    switch (opcode & 0xf800707f) {
        ...
        case 0x4000202f: rv32_i_amoor(cpu); return 1;
